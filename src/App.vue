<template>
      ...
      <div class="mx-auto max-w-screen-2xl flex items-center justify-between">
        <div class="flex items-center justify-start">
          <a href="/" class="mr-14 flex">
            ...
            <span class="hidden self-center whitespace-nowrap text-2xl font-semibold sm:flex dark:text-white">Flowbite</span>
          </a>
          <!-- Desktop menu -->
          <div class="hidden w-full items-center justify-between lg:order-1 lg:w-auto lg:flex">
            <ul class="mt-4 flex flex-col text-sm font-medium lg:mt-0 lg:flex-row space-x-6 xl:space-x-8">
              <li>
                <a href="#" class="text-primary-700 dark:text-primary-500 block rounded" aria-current="page">Home</a>
              </li>
              <li>
                <a href="#" class="hover:text-primary-700 block text-gray-700 dark:text-gray-400 dark:hover:text-white">Messages</a>
              </li>
              <li>
                <a href="#" class="hover:text-primary-700 block text-gray-700 dark:text-gray-400 dark:hover:text-white">Profile</a>
              </li>
              <li>
                <a href="#" class="hover:text-primary-700 block text-gray-700 dark:text-gray-400 dark:hover:text-white">Settings</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="flex items-center justify-between lg:order-2">
          ...
          <!-- Apps -->
          <button type="button" data-dropdown-toggle="apps-dropdown" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600">
            <span class="sr-only">View notifications</span>
            <!-- Icon -->
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
          </button>
          <!-- Dropdown menu -->
          <div id="apps-dropdown" class="z-50 my-4 hidden max-w-sm list-none overflow-hidden rounded bg-white text-base shadow-lg divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              <a href="#" class="group block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                <svg aria-hidden="true" class="mx-auto mb-1 h-7 w-7 text-gray-400 dark:text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd" /></svg>
              ...
              <a href="#" class="group block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                <svg aria-hidden="true" class="mx-auto mb-1 h-7 w-7 text-gray-400 dark:text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zm0 2h10v7h-2l-1 2H8l-1-2H5V5z" clip-rule="evenodd" /></svg>
              ...
              <a href="#" class="group block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                <svg aria-hidden="true" class="mx-auto mb-1 h-7 w-7 text-gray-400 dark:text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" /><path fill-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clip-rule="evenodd" /></svg>
              ...
              <a href="#" class="group block rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600">
                <svg aria-hidden="true" class="mx-auto mb-1 h-7 w-7 text-gray-400 dark:text-gray-400 group-hover:text-gray-500 dark:group-hover:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" /></svg>
          ...
          <!-- Dropdown menu -->
          <div id="userMenuDropdown" class="z-50 my-4 hidden w-56 list-none rounded bg-white text-base shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
            <div class="px-4 py-3">
              <span class="block text-sm font-semibold text-gray-900 dark:text-white">Neil Sims</span>
              <span class="block truncate text-sm font-light text-gray-500 dark:text-gray-400">name@flowbite.com</span>
            </div>
            ...
            <ul class="py-1 font-light text-gray-500 dark:text-gray-400" aria-labelledby="userMenuDropdownButton">
              <li>
                <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg class="mr-2 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" /></svg> My likes</a>
              </li>
              <li>
                <a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg class="mr-2 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" /></svg> Collections</a>
              </li>
            </ul>
  ...
  <div class="flex overflow-hidden bg-gray-50 pt-16 dark:bg-gray-900">
    <div id="main-content" class="relative mx-auto h-full w-full max-w-screen-2xl overflow-y-auto bg-gray-50 dark:bg-gray-900">
      <main>
        <div class="px-4 pt-6 2xl:px-0">
          <div class="grid gap-4 2xl:grid-cols-3 xl:grid-cols-2">
            <!-- Main widget -->
            <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm 2xl:col-span-2 dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div class="mb-4 flex items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-end text-base font-medium text-green-500 dark:text-green-400">
                  12.5%
              ...
              <div class="mt-4 flex items-center justify-between border-t border-gray-200 pt-3 dark:border-gray-700 sm:pt-6">
                <div>
                  <button class="inline-flex items-center rounded-lg p-2 text-center text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button" data-dropdown-toggle="weekly-sales-dropdown">
                  ...
                  <!-- Dropdown menu -->
                  <div id="weekly-sales-dropdown" class="z-50 my-4 hidden list-none rounded bg-white text-base shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                ...
                <div class="flex-shrink-0">
                  <a href="#" class="text-primary-700 dark:text-primary-500 inline-flex items-center rounded-lg p-2 text-xs font-medium uppercase hover:bg-gray-100 sm:text-sm dark:hover:bg-gray-700">
                    Sales Report
                    <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              ...
              <div id="popover-description" data-popover role="tooltip" class="invisible absolute z-10 inline-block w-72 border border-gray-200 rounded-lg bg-white text-sm font-light text-gray-500 opacity-0 shadow-sm transition-opacity duration-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400">
                <div class="p-3 space-y-2">
                  ...
                  <a href="#" class="dark:text-primary-500 hover:text-primary-700 text-primary-600 dark:hover:text-primary-600 flex items-center font-medium">Read more <svg class="ml-1 h-4 w-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" /></svg></a>
                </div>
                <div data-popper-arrow />
              </div>
              <div class="sm:hidden">
                <label for="tabs" class="sr-only">Select tab</label>
                <select id="tabs" class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full border-0 border-b border-gray-200 rounded-t-lg bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                  <option>Statistics</option>
                  <option>Services</option>
                  <option>FAQ</option>
                </select>
              </div>
              <ul id="fullWidthTab" class="hidden rounded-lg text-center text-sm font-medium text-gray-500 sm:flex divide-x divide-gray-200 dark:text-gray-400 dark:divide-gray-600" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                <li class="w-full">
                  <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="true" class="inline-block w-full rounded-tl-lg bg-gray-50 p-4 dark:bg-gray-700 hover:bg-gray-100 focus:outline-none dark:hover:bg-gray-600">
                    Top products
                  </button>
                </li>
                <li class="w-full">
                  <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about" aria-selected="false" class="inline-block w-full rounded-tr-lg bg-gray-50 p-4 dark:bg-gray-700 hover:bg-gray-100 focus:outline-none dark:hover:bg-gray-600">
                    Top Customers
                  </button>
                </li>
              </ul>
              <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                <div id="faq" class="hidden pt-4" role="tabpanel" aria-labelledby="faq-tab">
                  <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    <li class="py-3 sm:py-4">
                      <div class="flex items-center justify-between">
                        <div class="min-w-0 flex items-center">
                          <img class="h-10 w-10 flex-shrink-0" src="/images/products/iphone.png" alt="imac image">
                          <div class="ml-3">
                            <p class="truncate font-medium text-gray-900 dark:text-white">
                              iPhone 14 Pro
                            </p>
                            <div class="flex flex-1 items-center justify-end text-sm text-green-500 dark:text-green-400">
                    ...
                    <li class="py-3 sm:py-4">
                      <div class="flex items-center justify-between">
                        <div class="min-w-0 flex items-center">
                          <img class="h-10 w-10 flex-shrink-0" src="/images/products/imac.png" alt="imac image">
                          <div class="ml-3">
                            <p class="truncate font-medium text-gray-900 dark:text-white">
                              Apple iMac 27"
                            </p>
                    ...
                    <li class="py-3 sm:py-4">
                      <div class="flex items-center justify-between">
                        <div class="min-w-0 flex items-center">
                          <img class="h-10 w-10 flex-shrink-0" src="/images/products/watch.png" alt="watch image">
                          <div class="ml-3">
                            <p class="truncate font-medium text-gray-900 dark:text-white">
                              Apple Watch SE
                            </p>
                            <div class="flex flex-1 items-center justify-end text-sm text-red-600 dark:text-red-500">
                              <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <li class="py-3 sm:py-4">
                      <div class="flex items-center justify-between">
                        <div class="min-w-0 flex items-center">
                          <img class="h-10 w-10 flex-shrink-0" src="/images/products/ipad.png" alt="ipad image">
                          <div class="ml-3">
                            <p class="truncate font-medium text-gray-900 dark:text-white">
                              Apple iPad Air
                            </p>
                ...
                <div id="about" class="hidden pt-4" role="tabpanel" aria-labelledby="about-tab">
                  <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    <li class="py-3 sm:py-4">
              ...
              <div class="mt-5 flex items-center justify-between border-t border-gray-200 pt-3 dark:border-gray-700 sm:pt-6">
                <div>
                  <button class="inline-flex items-center rounded-lg p-2 text-center text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button" data-dropdown-toggle="stats-dropdown">
                    Last 7 days <svg class="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                  </button>
                  <!-- Dropdown menu -->
                  <div id="stats-dropdown" class="z-50 my-4 hidden list-none rounded bg-white text-base shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                    <div class="px-4 py-3" role="none">
                      <p class="truncate text-sm font-medium text-gray-900 dark:text-white" role="none">
                        Sep 16, 2021 - Sep 22, 2021
                      </p>
          ...
          <div class="grid grid-cols-1 mt-4 w-full gap-4 2xl:grid-cols-3 xl:grid-cols-2">
            <div class="items-center justify-between border border-gray-200 rounded-lg bg-white p-4 shadow-sm sm:flex dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div class="w-full">
                ...
                <p class="flex items-center text-base font-normal text-gray-500 dark:text-gray-400">
                  <span class="mr-1.5 flex items-center text-sm text-green-500 dark:text-green-400">
                    <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path clip-rule="evenodd" fill-rule="evenodd" d="M10 17a.75.75 0 01-.75-.75V5.612L5.29 9.77a.75.75 0 01-1.08-1.04l5.25-5.5a.75.75 0 011.08 0l5.25 5.5a.75.75 0 11-1.08 1.04l-3.96-4.158V16.25A.75.75 0 0110 17z" />
                    </svg>
                    12.5%
              ...
              <div id="new-products-chart" class="w-full" />
            </div>
            <div class="items-center justify-between border border-gray-200 rounded-lg bg-white p-4 shadow-sm sm:flex dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div class="w-full">
                <h3 class="text-base font-normal text-gray-500 dark:text-gray-400">
              ...
              <div id="week-signups-chart" class="w-full" />
            </div>
            <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div class="w-full">
                ...
                <div class="mb-2 flex items-center">
                  ...
                  <div class="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                    <div class="bg-primary-600 dark:bg-primary-500 h-2.5 rounded-full" style="width: 18%" />
                  </div>
                </div>
                <div class="mb-2 flex items-center">
                  <div class="w-16 text-sm font-medium dark:text-white">
                  ...
                  <div class="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                    <div class="bg-primary-600 dark:bg-primary-500 h-2.5 rounded-full" style="width: 15%" />
                  </div>
                </div>
                <div class="mb-2 flex items-center">
                  <div class="w-16 text-sm font-medium dark:text-white">
                  ...
                  <div class="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                    <div class="bg-primary-600 dark:bg-primary-500 h-2.5 rounded-full" style="width: 60%" />
                  </div>
                </div>
                <div class="mb-2 flex items-center">
                  <div class="w-16 text-sm font-medium dark:text-white">
                  ...
                  <div class="h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                    <div class="bg-primary-600 dark:bg-primary-500 h-2.5 rounded-full" style="width: 30%" />
                  </div>
                </div>
              </div>
          ...
          <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
            <div class="mb-4 border border-gray-200 rounded-lg bg-white p-4 shadow-sm xl:mb-0 dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div class="mb-4 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                  Smart chat
                </h3>
                <a href="#" class="text-primary-700 dark:text-primary-500 inline-flex items-center rounded-lg p-2 text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700">
                  View all
                </a>
              </div>
              <!-- Chat -->
              <form class="overflow-y-auto 2xl:max-h-fit lg:max-h-[60rem]">
                <article class="mb-5">
                  <footer class="mb-2 flex items-center justify-between">
                    ...
                    <button id="dropdownComment1Button" data-dropdown-toggle="dropdownComment1" class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 dark:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-gray-600" type="button">
                      <svg
                        class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownComment1" class="z-10 hidden w-36 rounded bg-white shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                  ...
                  <p class="mb-2 text-gray-900 dark:text-white">
                    Hello <a href="#" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@designteam</a> Let's schedule a kick-off meeting and workshop this week. It would be great to gather everyone involved in the design project. Let me know about your availability in the thread.
                  </p>
                  <p class="mb-3 text-gray-900 dark:text-white">
                    Looking forward to it! Thanks.
                  </p>
                  <a href="#" class="text-primary-700 dark:text-primary-500 inline-flex items-center text-xs font-medium sm:text-sm">
                    4 replies
                    <svg class="ml-1 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <article class="mb-5">
                  <footer class="mb-2 flex items-center justify-between">
                    <div class="flex items-center">
                      <p class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                        <img class="mr-2 h-6 w-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="Bonnie avatar">Bonnie Green
                      </p>
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        <time pubdate datetime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time>
                      </p>
                    </div>
                    <button id="dropdownComment2Button" data-dropdown-toggle="dropdownComment2" class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 dark:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-gray-600" type="button">
                      <svg
                        class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownComment2" class="z-10 hidden w-36 rounded bg-white shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                      <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                        <li>
                          <a
                            href="#"
                  ...
                  <div class="mb-2 flex items-center space-x-2">
                    <button type="button" class="inline-flex items-center rounded-lg bg-gray-100 px-3 py-1.5 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600">
                ...
                <article class="mb-5">
                  <footer class="mb-2 flex items-center justify-between">
                    <div class="flex items-center">
                      <p class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                        <img class="mr-2 h-6 w-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Jese avatar">Jese Leos
                      </p>
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        <time pubdate datetime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time>
                      </p>
                    </div>
                    <button id="dropdownComment3Button" data-dropdown-toggle="dropdownComment3" class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 dark:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-gray-600" type="button">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownComment3" class="z-10 hidden w-36 rounded bg-white shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                      <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                        <li>
                  ...
                  <p class="mb-2 text-gray-900 dark:text-white">
                    Ok <a href="#" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@team</a> I'am attaching our offer and pitch deck. Take your time to review everything. I'am looking forward to the next steps! Thank you.
                  </p>
                  <p class="mb-3 text-gray-900 dark:text-white">
                    Looking forward to it! Thanks.
                  </p>
                  <div class="items-center 2xl:flex 2xl:space-x-4">
                    <!-- Item -->
                    <div class="mb-3.5 flex items-center border border-gray-200 rounded-lg p-3 dark:border-gray-700">
                      <div class="bg-primary-100 dark:bg-primary-900 mr-3 h-10 w-10 flex items-center justify-center rounded-lg">
                        <svg class="text-primary-600 dark:text-primary-300 h-5 w-5 lg:h-6 lg:w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      ...
                      <div class="ml-auto flex items-center">
                        <button type="button" class="rounded p-2 hover:bg-gray-100">
                          <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <!-- Item -->
                    <div class="mb-3.5 flex items-center border border-gray-200 rounded-lg p-3 dark:border-gray-700">
                      <div class="mr-3 h-10 w-10 flex items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900">
                        <svg class="h-5 w-5 text-teal-600 lg:h-6 lg:w-6 dark:text-teal-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <article class="mb-5 pl-12">
                  <footer class="mb-2 flex items-center justify-between">
                    <div class="flex items-center">
                      <p class="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                        <img class="mr-2 h-6 w-6 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-1.jpg" alt="Joseph avatar">Joseph McFallen
                      </p>
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        <time pubdate datetime="2022-02-08" title="February 8th, 2022"> 01/03/2023 4:15 PM</time>
                      </p>
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownComment4" class="z-10 hidden w-36 rounded bg-white shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                      <ul
                  ...
                  <p class="mb-2 text-gray-900 dark:text-white">
                    Hello <a href="#" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@jeseleos</a> I need some informations about flowbite react version.
                  </p>
                </article>
                <article class="mb-5 pl-12">
                  <footer class="mb-2 flex items-center justify-between">
                    ...
                    <button id="dropdownComment5Button" data-dropdown-toggle="dropdownComment5" class="inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 dark:bg-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-50 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:ring-gray-600" type="button">
                      <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                      </svg>
                      <span class="sr-only">Comment settings</span>
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownComment5" class="z-10 hidden w-36 rounded bg-white shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                      <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                        <li>
                          <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                        </li>
                  ...
                  <p class="mb-4 text-gray-900 dark:text-white">
                    Hi <a href="#" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@josephh</a> Sure, just let me know whean you are available and we can speak.
                  </p>
                  <form>
                    <label for="chat" class="sr-only">Your message</label>
                    <div class="mb-5 flex items-center">
                      <textarea id="chat" rows="1" class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 mr-4 block w-full border border-gray-300 rounded-lg bg-white p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400" placeholder="Reply in thread..." />
                      <button type="submit" class="text-primary-600 dark:text-primary-500 hover:bg-primary-100 inline-flex cursor-pointer justify-center rounded-lg p-2 dark:hover:bg-gray-600">
                        <svg aria-hidden="true" class="h-6 w-6 rotate-90" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" /></svg>
                        <span class="sr-only">Send message</span>
                      </button>
                    </div>
                  </form>
                  <span class="text-primary-700 dark:text-primary-500 inline-flex cursor-pointer items-center text-xs font-medium sm:text-sm hover:underline">
                    Hide thread
                    <svg class="ml-1 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                  <div class="rounded-t-lg bg-white px-4 py-2 dark:bg-gray-800">
                    <label for="comment" class="sr-only">Write your message</label>
                    <textarea id="comment" rows="8" class="w-full border-0 bg-white px-0 text-sm text-gray-900 dark:bg-gray-800 dark:text-white focus:ring-0 dark:placeholder-gray-400" placeholder="Write your message" required />
                  </div>
                  <div class="flex items-center justify-between border-t px-3 py-2 dark:border-gray-600">
                    <button type="submit" class="bg-primary-700 focus:ring-primary-200 hover:bg-primary-800 dark:focus:ring-primary-900 inline-flex items-center rounded-lg px-4 py-2.5 text-center text-xs font-medium text-white focus:ring-4">
                      Send message
                    </button>
                    <div class="flex pl-0 space-x-1 sm:pl-2">
                      <button type="button" class="inline-flex cursor-pointer justify-center rounded p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg>
                        <span class="sr-only">Attach file</span>
                      </button>
                      <button type="button" class="inline-flex cursor-pointer justify-center rounded p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" /></svg>
                        <span class="sr-only">Set location</span>
                      </button>
                      <button type="button" class="inline-flex cursor-pointer justify-center rounded p-2 text-gray-500 hover:bg-gray-100 dark:text-gray-400 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clip-rule="evenodd" /></svg>
            ...
            <div class="grid gap-4">
              <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                <div class="items-center justify-between border-b border-gray-200 pb-4 sm:flex dark:border-gray-700">
                  ...
                  <div class="max-w-lg w-full">
                    <div date-rangepicker class="grid grid-cols-2 items-center gap-4">
                      <div class="relative">
                        ...
                        <input name="start" type="text" class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full border border-gray-300 rounded-lg bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" placeholder="From">
                      </div>
                      <div class="relative">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                          <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <input name="end" type="text" class="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full border border-gray-300 rounded-lg bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" placeholder="To">
                      </div>
                    </div>
                  </div>
                </div>
                <div id="sales-by-category" class="w-full" />
                <!-- Card Footer -->
                <div class="mt-4 flex items-center justify-between border-t border-gray-200 pt-3 dark:border-gray-700 sm:pt-6">
                  <div>
                    <button class="inline-flex items-center rounded-lg p-2 text-center text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button" data-dropdown-toggle="sales-by-category-dropdown">
                      Last 7 days <svg class="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                    </button>
                    <!-- Dropdown menu -->
                    <div id="sales-by-category-dropdown" class="z-50 my-4 hidden list-none rounded bg-white text-base shadow divide-y divide-gray-100 dark:bg-gray-700 dark:divide-gray-600">
                      <div class="px-4 py-3" role="none">
                        <p class="truncate text-sm font-medium text-gray-900 dark:text-white" role="none">
                          Sep 16, 2021 - Sep 22, 2021
                        </p>
              ...
              <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                ...
                <div class="flex items-center justify-between pt-4 lg:justify-evenly sm:pt-6">
                  <div>
                    <svg class="mb-1 h-8 w-8 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <div>
                    ...
                    <p class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                      <span class="mr-1.5 flex items-center text-sm text-red-600 dark:text-red-500">
                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                          <path clip-rule="evenodd" fill-rule="evenodd" d="M10 3a.75.75 0 01.75.75v10.638l3.96-4.158a.75.75 0 111.08 1.04l-5.25 5.5a.75.75 0 01-1.08 0l-5.25-5.5a.75.75 0 111.08-1.04l3.96 4.158V3.75A.75.75 0 0110 3z" />
                        </svg>
                        1%
          ...
          <div class="grid grid-cols-1 my-4 xl:grid-cols-2 xl:gap-4">
            ...
            <div class="mb-4 border border-gray-200 rounded-lg bg-white p-4 shadow-sm xl:mb-0 dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              ...
              <ol class="relative border-l border-gray-200 dark:border-gray-700">
                <li class="mb-10 ml-4">
                  <div class="absolute mt-1.5 h-3 w-3 border border-white rounded-full bg-gray-200 -left-1.5 dark:border-gray-800 dark:bg-gray-700" />
                  ...
                  <a href="#" class="hover:text-primary-700 focus:text-primary-700 inline-flex items-center border border-gray-200 rounded-lg bg-white px-4 py-2 text-sm font-medium text-gray-900 focus:z-10 dark:border-gray-600 dark:bg-gray-800 hover:bg-gray-100 dark:text-gray-400 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Learn more <svg class="ml-2 h-3 w-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" /></svg></a>
                </li>
                <li class="mb-10 ml-4">
                  <div class="absolute mt-1.5 h-3 w-3 border border-white rounded-full bg-gray-200 -left-1.5 dark:border-gray-800 dark:bg-gray-700" />
                  ...
                  <a href="https://flowbite.com/blocks/" class="text-primary-700 dark:text-primary-500 inline-flex items-center text-xs font-medium sm:text-sm hover:underline">
                    Go to Flowbite Blocks
                    <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div class="border border-gray-200 rounded-lg bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
              <div id="carousel" class="relative" data-carousel="">
                <div class="relative mx-auto h-[36rem] overflow-hidden lg:h-[24rem]">
                  <div class="hidden bg-white duration-700 ease-in-out dark:bg-gray-800" data-carousel-item>
                    <div class="text-primary-600 mb-4 flex items-center text-lg font-medium">
                      <svg class="mr-2 h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <ul class="mb-4 list-disc pl-4 text-gray-500 space-y-3 dark:text-gray-400">
                    ...
                    <a href="#" class="text-primary-700 dark:text-primary-500 inline-flex items-center rounded-lg p-2 font-medium hover:bg-gray-100 dark:hover:bg-gray-700">
                      Get me there
                      <svg class="ml-1 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <div class="hidden bg-white duration-700 ease-in-out dark:bg-gray-800" data-carousel-item>
                    ...
                    <ul role="list" class="mb-4 list-disc pl-2 text-gray-500 space-y-3 dark:text-gray-400">
                      <li class="flex space-x-2">
                        <!-- Icon -->
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  ...
                  <div class="hidden bg-white duration-700 ease-in-out dark:bg-gray-800" data-carousel-item>
                    ...
                    <!-- List -->
                    <ul role="list" class="my-5 mb-4 list-disc pl-2 text-gray-500 space-y-3 dark:text-gray-400">
                      <li class="flex space-x-3">
                        <!-- Icon -->
                        <svg class="h-5 w-5 flex-shrink-0 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" /></svg>
                        <span class="leading-tight">Dynamic reports and dashboards</span>
                      </li>
                      <li class="flex space-x-3">
                        <!-- Icon -->
                    ...
                    <button type="button" class="hover:text-primary-700 inline-flex items-center border border-gray-200 rounded-lg bg-white px-3 py-2 text-sm font-medium text-gray-900 focus:z-10 dark:border-gray-600 dark:bg-gray-800 hover:bg-gray-100 dark:text-gray-400 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">
                      View more
                      <svg class="ml-1 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path clip-rule="evenodd" fill-rule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" />
                      </svg>
                ...
                <div class="flex items-center justify-center">
                  <button type="button" class="group mr-4 h-full flex cursor-pointer items-center justify-center focus:outline-none" data-carousel-prev>
                    <span class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                      <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z" clip-rule="evenodd" /></svg>
                      <span class="hidden">Previous</span>
                    </span>
                  </button>
                  <button type="button" class="group h-full flex cursor-pointer items-center justify-center focus:outline-none" data-carousel-next>
                    <span class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                      <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                  ...
                  <div id="dropdown" class="z-10 hidden w-56 rounded-lg bg-white p-3 shadow dark:bg-gray-700">
                    ...
                    <ul class="text-sm space-y-2" aria-labelledby="dropdownDefault">
                      <li class="flex items-center">
                        <input id="apple" type="checkbox" value="" class="text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 h-4 w-4 border-gray-300 rounded bg-gray-100 dark:border-gray-500 dark:bg-gray-600 focus:ring-2 dark:ring-offset-gray-700">
                      ...
                      <li class="flex items-center">
                        <input id="fitbit" type="checkbox" value="" checked class="text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 h-4 w-4 border-gray-300 rounded bg-gray-100 dark:border-gray-500 dark:bg-gray-600 focus:ring-2 dark:ring-offset-gray-700">
                      ...
                      <li class="flex items-center">
                        <input id="dell" type="checkbox" value="" class="text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 h-4 w-4 border-gray-300 rounded bg-gray-100 dark:border-gray-500 dark:bg-gray-600 focus:ring-2 dark:ring-offset-gray-700">
                      ...
                      <li class="flex items-center">
                        <input id="asus" type="checkbox" value="" checked class="text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 h-4 w-4 border-gray-300 rounded bg-gray-100 dark:border-gray-500 dark:bg-gray-600 focus:ring-2 dark:ring-offset-gray-700">
      ...
      <footer class="px-4 py-6 md:flex md:items-center md:justify-between 2xl:px-0 md:py-10">
        <p class="mb-4 text-center text-sm text-gray-500 md:mb-0">
          &copy; 2019-2013 <a href="/" class="hover:underline" target="_blank">Flowbite.com</a>. All rights reserved.
        </p>
